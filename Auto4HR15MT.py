...
print(f"BTC_Price: {BTC_price} / ETH_Price: {ETH_price} / ADA_Price: {ADA_price} / TRX_Price: {TRX_price} / CHZ_Price: {CHZ_price} / MANA_Price: {MANA_price}")
print("---------------------------------------------------------------------------------------------------------------------------")
time.sleep(1)
...
print(f"BTC_mt15: {BTC_mt15:.1f} / ETH_mt15: {ETH_mt15:.1f} / ADA_mt15: {ADA_mt15:.1f} / TRX_mt15: {TRX_mt15:.1f} / CHZ_mt15: {CHZ_mt15:.1f} / MANA_mt15: {MANA_mt15:.1f}")
print("---------------------------------------------------------------------------------------------------------------------------")
time.sleep(1)
...
while True:
    ...
    try:
        ...
        if (now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21) and now.minute == 0 and (35 <= now.second <= 45):
